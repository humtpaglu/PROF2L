...
class Telegram:
    ...
    BOT_TOKEN = str(env.get("BOT_TOKEN", '7781615462:AAHT9qKJyhFTU2GqqbmUjF8l8etaJrjjEww'))
    OWNER_ID = int(env.get('OWNER_ID', '1572626591'))
    WORKERS = int(env.get("WORKERS", "6"))  # 6 workers = 6 commands at once
    DATABASE_URL = str(env.get('DATABASE_URL', 'mongodb+srv://thehopea14:Lastfix@cluster0.4tia8bq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'))
    ...
    MULTI_CLIENT = False
    FLOG_CHANNEL = int(env.get("FLOG_CHANNEL", '-1002637340403'))   # Logs channel for file logs
    ULOG_CHANNEL = int(env.get("ULOG_CHANNEL", '-1002637340403'))   # Logs channel for user logs
